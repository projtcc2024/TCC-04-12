...
<span class="close" id="close-popup">&times;</span>
    <header class="header">
        ...
        <nav class="navbar">
            ...
            <a href="infouserAdmin.php" class="active"><i class="bx bxs-user-circle"></i></a>
...
<main>
    ...
    if ($_SERVER['REQUEST_METHOD'] == 'POST') {
        ...
        header("Refresh: 2; URL=infouserAdmin.php"); // Redireciona após 3 segundos
    
    }
    ?>
    <form method="POST" action="infouserAdmin.php">
    ...
    if (isset($_SESSION['tipoUser']) && $_SESSION['tipoUser'] == 1) {
        echo '<a href="../index.php" class="btn">Alternar para Usuário</a>';
    }
    ?>
    </form>
